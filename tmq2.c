...
// Only numbers 0-9 have an effect.
...
void input()
{
	...
	glRasterPos2f(310,420);
	for(int i=0;i<19;i++)
		glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,s[i]);
	char msg[]="ENTER THE NUMBER OF QUEENS TO CONTINUE!";
	glColor3f(0.3,0.3,0.3);
	glRasterPos2f(255,210);
	for(int i=0;i<39;i++)
		glutBitmapCharacter(GLUT_BITMAP_HELVETICA_18,msg[i]);
	char s1[]="CREATED BY: Deepak Bhagchandani & Chaitanya Nettem",g[]="UNDER THE GUIDANCE OF - Prof. Kiran P";
	glColor3f(0.3,0.3,0.3);
	glRasterPos2f(15,60);
	for(int i=0;i<50;i++)
			...
			for(i=0;i<n;i+=2)
				{
					...
					glVertex2i(50+(100*(i+k)),50+(100*j));
